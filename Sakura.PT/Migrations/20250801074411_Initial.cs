        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SakuraCoins = table.Column<decimal>(type: "numeric(20,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchVector = table.Column<NpgsqlTsVector>(type: "tsvector", nullable: false)
                        ...
                        .Annotation("Npgsql:TsVectorProperties", new[] { "Name", "Description", "ImdbId" })
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Badges",
                columns: new[] { "Id", "Description", "ImageUrl", "IsPurchasable", "Name" },
                values: new object[,]
                {
                    { 1, "Joined the site in its early days.", "/images/badges/early_supporter.png", false, "Early Supporter" },
                    { 2, "Uploaded 100+ torrents.", "/images/badges/torrent_master.png", false, "Torrent Master" },
                    { 3, "Active in forums and comments.", "/images/badges/community_contributor.png", false, "Community Contributor" },
                    { 4, "Purchased from the store.", "/images/badges/coin_collector.png", true, "Sakura Coin Collector" }
                });

            migrationBuilder.InsertData(
                table: "StoreItems",
                columns: new[] { "Id", "BadgeId", "Description", "IsAvailable", "ItemCode", "Name", "Price" },
                values: new object[,]
                {
                    { 1, null, "Add 10 GB to your total upload amount.", true, 0, "10 GB Upload Credit", 1000m },
                    { 2, null, "Add 50 GB to your total upload amount.", true, 1, "50 GB Upload Credit", 4500m },
                    { 3, null, "Receive one invitation code to share with a friend.", true, 2, "1 Invite Code", 5000m },
                    { 4, null, "Receive five invitation codes to share with your friends.", true, 3, "5 Invite Codes", 20000m },
                    { 5, null, "All your uploads count double for 24 hours.", true, 4, "Double Upload (24h)", 10000m },
                    { 6, null, "Exempt from Hit & Run rules for 72 hours.", true, 5, "No Hit & Run (72h)", 15000m },
                    { 7, 4, "Show off your dedication to SakuraCoins!", true, 6, "Sakura Coin Collector Badge", 25000m }
                });
